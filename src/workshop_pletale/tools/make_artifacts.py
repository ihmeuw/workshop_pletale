...
from workshop_pletale.constants import data_keys, metadata
from workshop_pletale.tools.app_logging import add_logging_sink, decode_status
from workshop_pletale.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from workshop_pletale.data import builder
