...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "workshop_pletale", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/workshop_pletale/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=workshop_pletale.tools.cli:make_artifacts
        """,
    )
